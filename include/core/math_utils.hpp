...
namespace geocalcul {
// Première version a changé après avec directement la structure Node quand
// j'aurais fini cette parti

constexpr double RADIUS_EARTH = 6371.0;

// Pour conversion degrés en radiant pour les calculs trigo a répétition et
// chiant Conversion latitude longitude d'un plan 2d à une l'échelle sphérique
