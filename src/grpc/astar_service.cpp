...
// A voir si ça sert vraiment de stocker le graph en mémoire séparer de la résolution
// Initialement c'était pour save le graph dans redis, mais en vrai on peut tous faire d'un coup ça évite de faire un double appel
// Sachant que on va sur du snapshot ça rentre ça calcul et ça sort

::grpc::Status AStarServiceImpl::StoreGraph(
    ::grpc::ServerContext*, const ::astar::proto::GraphRequest* req, ::astar::proto::StoreResponse* res)
{
...
::grpc::Status AStarServiceImpl::Solve(
    ::grpc::ServerContext*, const ::astar::proto::SolveRequest* req, ::astar::proto::SolveResponse* res)
{
